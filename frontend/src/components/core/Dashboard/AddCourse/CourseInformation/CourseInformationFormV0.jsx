...
export default function CourseInformationForm() {
  ...
  useEffect(() => {
    ...
    if (editCourse) {
      ...
      // DO NOT set courseImage to a string URL; Upload handles preview separately
    }
  ...
  const isFormUpdated = () => {
    ...
    return (
        ...
        // For courseImage, just check if it's a File object (new upload) or not
      ...
      >
        ...
        <div className="flex flex-col space-y-2">
          ...
          {errors.courseMatiere && (
              <span className="ml-2 text-xs tracking-wide text-pink-200">Course Matiere is required</span>
          )}
        </div>
        ...
        {/* PDF Upload */}
        <div>
          <label className="block mb-1 font-semibold text-gray-700">Upload Course PDF (optional)</label>
          <input
              type="file"
              ref={fileInputRef}
              name="pdf"
