...
exports.createCourse = async (req, res) => {
    try {
        // extract data
        let { courseName, courseDescription, whatYouWillLearn, price, category, instructions: _instructions, status, tag: _tag,matiere } = req.body;
        ...
        /*
         ...
         const newCourse = await Course.create({
              ...
              tag, status, instructions, thumbnail: thumbnailDetails.secure_url, matiere: matiere ,  createdAt: Date.now(),
          });
          */
